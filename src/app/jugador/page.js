...
export default function CamisasJugador() {
  ...
  const fetchCamisas = useCallback(async (page = 1, search = '') => {
    setLoading(true);
    try {
      let url = `/api/camisas?categorias=JUGADOR,JUGADOR2&page=${page}&limit=50`;
      if (search.trim()) {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">Cargando camisas de jugador...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Camisas de Jugador</h1>
            </div>
        ...
        {camisas.length === 0 ? (
          <div className="text-center py-20">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 max-w-md mx-auto">
              ...
              <p className="text-gray-500">Las camisas de jugador estarán disponibles pronto</p>
            </div>
          </div>
        ) : (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-500">
                  Página {pagination.currentPage} de {pagination.totalPages} • {pagination.totalCamisas} camisas de jugador disponibles
                </p>
              </div>
              <Pagination
